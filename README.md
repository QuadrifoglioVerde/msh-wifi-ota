...
Nahradime OTA v zarizeni (port a nazev.bin nahradte vlastnim!): esptool.exe -b 115200 -p COM5 write_flash 0x340000 esp32s3.bin

Restartujeme zarizeni do OTA rezimu: meshtastic --host IP.ADRESA --reboot-ota

Nahrajeme FW: espota.exe -i IP.ADRESA -f firmware-*-update.bin (VYBRAT verzi -update, jinak to bricknete!)
